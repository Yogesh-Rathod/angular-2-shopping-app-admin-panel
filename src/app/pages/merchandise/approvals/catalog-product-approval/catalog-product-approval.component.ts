...
@Component({
  selector: 'app-catalog-product-approval',
  templateUrl: './catalog-product-approval.component.html',
  styleUrls: ['./catalog-product-approval.component.scss']
})
export class CatalogProductApprovalComponent implements OnInit {
